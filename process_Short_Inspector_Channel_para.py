...
errTitle = 'Error_Process_Short_Channel_Insector_Parallel'
warningTitle = 'Warning_Process_Short_Channel_Inspector_Parallel'
lockFile = '/home/karsten/tmp/Process_Short_Channel_Inspector_Parallel.LOCK'
...
for hourBack in range(hoursBack,hoursLag,-1):
   ...
   for hrFcst in range(1,19):
      ...
      completePath = completeDir + '/nwm.t' + hrStrCycle + \
                     ...
                     '_f' + fStr + '.COMPLETE'
      fileDPath = 'nwm.t' + hrStrCycle + 'z.short_range.channel_rt.f' + fStr + '.conus.nc'
