...
errTitle = 'Error_Process_Medium_Terrain_Inspector'
warningTitle = 'Warning_Process_Medium_Terrain_Inspector'
lockFile = '/home/karsten/tmp/Process_Medium_Terrain_Inspector.LOCK'
		...
		for hrFcst in range(3,243,3):
		   ...
		   # posted to hydro-c1-web to ingest into hydroInspector.
			...
			completePath = completeDir + '/nwm.t' + hrStrCycle + \
		                  'z.medium_range.terrain_rt.tm00.conus_' + dStr1Cycle + \
								'_f' + fStr + '.COMPLETE'	   
			fileDPath = 'nwm.t' + hrStrCycle + 'z.medium_range.terrain_rt.f' + fStr + '.conus.nc.gz'
			filePath = 'nwm.t' + hrStrCycle + 'z.medium_range.terrain_rt.f' + fStr + '.conus.nc'
