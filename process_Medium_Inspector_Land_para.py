...
errTitle = 'Error_Process_Medium_Land_Inspector_Parallel'
warningTitle = 'Warning_Process_Medium_Land_Para_Inspector_Parallel'
lockFile = '/home/karsten/tmp/Process_Medium_Land_Inspector_Parallel.LOCK'
		...
		for hrFcst in range(3,243,3):
		   ...
		   # posted to hydro-c1-web to ingest into hydroInspector.
			...
			completePath = completeDir + '/nwm.t' + hrStrCycle + \
		                  ...
		                  '_f' + fStr + '.COMPLETE'
			fileDPath = 'nwm.t' + hrStrCycle + 'z.medium_range.land.f' + fStr + '.conus.nc'
