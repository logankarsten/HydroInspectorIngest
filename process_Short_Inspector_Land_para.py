...
errTitle = 'Error_Process_Short_Land_Insector_Parallel'
warningTitle = 'Warning_Process_Short_Land_Inspector_Parallel'
lockFile = '/home/karsten/tmp/Process_Short_Land_Inspector_Parallel.LOCK'
