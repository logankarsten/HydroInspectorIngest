...
errTitle = 'Error_Process_Short_Terrain_Inspector'
warningTitle = 'Warning_Process_Short_Terrain_Inspector'
lockFile = '/home/karsten/tmp/Process_Short_Terrain_Inspector.LOCK'
	   ...
	   # posted to hydro-c1-web to ingest into hydroInspector.
		...
		completePath = completeDir + '/nwm.t' + hrStrCycle + \
	                  'z.short_range.terrain_rt.tm00.conus_' + dStr1Cycle + \
							'_f' + fStr + '.COMPLETE'	   
		fileDPath = 'nwm.t' + hrStrCycle + 'z.short_range.terrain_rt.f' + fStr + '.conus.nc.gz'
		filePath = 'nwm.t' + hrStrCycle + 'z.short_range.terrain_rt.f' + fStr + '.conus.nc'
